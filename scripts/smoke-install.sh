...
assert_file "$TMP_HOME/html-explainer/docs/AUTODISCOVERY.md"
assert_file "$TMP_HOME/html-explainer/docs/CONTEXT_PACKS.md"
assert_file "$TMP_HOME/html-explainer/docs/DECISION_COST_GATE.md"
assert_file "$TMP_HOME/html-explainer/docs/EXPLAINER_CLARITY.md"
...
assert_file "$TMP_HOME/html-explainer/docs/HTML_DELIVERY.md"
assert_file "$TMP_HOME/html-explainer/docs/THARIQ_SITE_LEARNINGS.md"
assert_file "$TMP_HOME/html-explainer/docs/USER_IN_THE_LOOP.md"
assert_file "$TMP_HOME/html-explainer/docs/VISUAL_EXPLAINER_PLAYBOOK.md"
assert_file "$TMP_HOME/html-explainer/docs/VISUAL_STYLE_STANDARD.md"
assert_file "$TMP_HOME/html-explainer/docs/NEXT_ACTION_HANDOFF.md"
assert_file "$TMP_HOME/html-explainer/docs/SHARE_AND_REENTRY.md"
assert_file "$TMP_HOME/html-explainer/docs/PROCESS_CAPSULE.md"
assert_file "$TMP_HOME/html-explainer/docs/SENIOR_CHAINED_PROMPTS.md"
assert_file "$TMP_HOME/html-explainer/docs/EXPERT_PROMPT_GATES.md"
assert_file "$TMP_HOME/html-explainer/docs/COHERENCE_GUARD.md"
assert_file "$TMP_HOME/html-explainer/docs/pattern-router.md"
assert_file "$TMP_HOME/html-explainer/docs/QUALITY_BAR.md"
assert_file "$TMP_HOME/html-explainer/docs/LEAN_HTML_RENDERING.md"
