...
assert_contains "$TMP_HOME/CLAUDE.md" "Goal contracts live"

assert_dir "$TMP_HOME/html-explainer/docs"
assert_dir "$TMP_HOME/html-explainer/goals"
...
assert_file "$TMP_HOME/html-explainer/docs/COMPLETION_MODEL.md"
...
assert_file "$TMP_HOME/html-explainer/docs/GOAL_WORKFLOWS.md"
assert_file "$TMP_HOME/html-explainer/goals/artifact-ready.goal.md"
assert_file "$TMP_HOME/html-explainer/goals/repo-v1-complete.goal.md"
assert_file "$TMP_HOME/html-explainer/goals/docs-coherent.goal.md"
