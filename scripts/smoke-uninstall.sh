...
[ -f "$TMP_HOME/commands/html-effectiveness.md" ] || fail "install did not create command"
...
assert_absent "$TMP_HOME/commands/html-effectiveness.md"
assert_absent "$TMP_HOME/commands/html-pattern-select.md"
assert_absent "$TMP_HOME/commands/html-audit-artifact.md"
