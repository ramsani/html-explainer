...
|---|---|---|
| `before-after-decision.example.html` | Demo / quality gate | Why intent-led HTML is better than a skimmable answer. |
| `before-after-diff-review.example.html` | 03 Annotated PR / diff review | Before/after contrast for decision-ready diff review. |
...
| `before-after-prompt-tuner.example.html` | 20 Prompt / agent behavior tuner | Before/after contrast for agent behavior tuning. |
